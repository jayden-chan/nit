...
case $1 in
    ...
    connect)
        ...
        ;;
    download)
        scp -i ~/.ssh/gcp_ssh -r jayden@$GCP_VM_IP:/home/jayden/nit/$2 ./$2
        ;;
    download-img)
        scp -i ~/.ssh/gcp_ssh jayden@$GCP_VM_IP:/home/jayden/nit/out/image.ppm ./out/image.ppm
        feh --auto-zoom --force-aliasing out/image.ppm
        ;;
    download-ani)
        scp -i ~/.ssh/gcp_ssh jayden@$GCP_VM_IP:/home/jayden/nit/out/output.avi ./out/output.avi
    ...
    gen)
        ...
        for f in $(ls scenes/animation/); do
            ./target/release/nit "./scenes/animation/$f" "out/$f.ppm"
        done
